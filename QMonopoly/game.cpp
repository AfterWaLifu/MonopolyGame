...
void Game::setUpMap()
{
    ...
    map[1] = new MapSquare("Лоток на рынке", settings->ENTERPRISE);
    map[2] = new MapSquare("Овощебаза", settings->ENTERPRISE);
    map[3] = new MapSquare("Птичий рынок", settings->ENTERPRISE);
    map[4] = new MapSquare("Мир Отторг", settings->ENTERPRISE);
    map[5] = new MapSquare("Налоговая", settings->TAXES);
    map[6] = new MapSquare("Тюрьма", settings->JAIL);
    map[7] = new MapSquare("Пилорама", settings->ENTERPRISE);
    map[8] = new MapSquare("Стекольный завод", settings->ENTERPRISE);
    map[9] = new MapSquare("Сталелитейный\nзавод", settings->ENTERPRISE);
    map[10] = new MapSquare("Никелевый завод", settings->ENTERPRISE);
    ...
    map[16] = new MapSquare("BiLier", settings->ENTERPRISE);
    map[17] = new MapSquare("ОмегаФонк", settings->ENTERPRISE);
    map[18] = new MapSquare("Ж/д Вокзал", settings->TRAIN);
    map[19] = new MapSquare("Eric Games", settings->ENTERPRISE);
    map[20] = new MapSquare("Lizzard", settings->ENTERPRISE);
    map[21] = new MapSquare("Fliptendo", settings->ENTERPRISE);
    map[22] = new MapSquare("MegaSoft", settings->ENTERPRISE);
